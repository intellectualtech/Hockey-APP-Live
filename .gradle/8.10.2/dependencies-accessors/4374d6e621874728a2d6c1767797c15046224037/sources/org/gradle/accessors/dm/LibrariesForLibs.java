...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxDatastoreCoreLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>datastore.core.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>material3.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
    ...
    public static class AndroidxRoomLibraryAccessors extends SubDependencyFactory {
        private final AndroidxRoomExternalLibraryAccessors laccForAndroidxRoomExternalLibraryAccessors = new AndroidxRoomExternalLibraryAccessors(owner);

        public AndroidxRoomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.room.external</b>
         */
        public AndroidxRoomExternalLibraryAccessors getExternal() {
            return laccForAndroidxRoomExternalLibraryAccessors;
        }

    }

    public static class AndroidxRoomExternalLibraryAccessors extends SubDependencyFactory {

        public AndroidxRoomExternalLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>antlr</b> with <b>androidx.room:room-external-antlr</b> coordinates and
         * with version reference <b>room.external.antlr</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAntlr() {
            return create("androidx.room.external.antlr");
        }
    ...
    public static class AndroidxUiTestLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.ui.test.junit4</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>play.services.games</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidGradleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>android.gradle.plugin</b> with value <b>8.5.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxUiVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxUiTestVersionAccessors vaccForAndroidxUiTestVersionAccessors = new AndroidxUiTestVersionAccessors(providers, config);
        public AndroidxUiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.androidx.ui.test</b>
         */
        public AndroidxUiTestVersionAccessors getTest() {
            return vaccForAndroidxUiTestVersionAccessors;
        }

    }

    public static class AndroidxUiTestVersionAccessors extends VersionFactory  {

        public AndroidxUiTestVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>androidx.ui.test.junit4</b> with value <b>1.6.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJunit4() { return getVersion("androidx.ui.test.junit4"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.navigation</b> with value <b>1.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class DatastoreVersionAccessors extends VersionFactory  {
        ...
        private final DatastoreCoreVersionAccessors vaccForDatastoreCoreVersionAccessors = new DatastoreCoreVersionAccessors(providers, config);
        public DatastoreVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.datastore.core</b>
         */
        public DatastoreCoreVersionAccessors getCore() {
            return vaccForDatastoreCoreVersionAccessors;
        }

    }

    public static class DatastoreCoreVersionAccessors extends VersionFactory  {

        public DatastoreCoreVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>datastore.core.android</b> with value <b>1.1.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroid() { return getVersion("datastore.core.android"); }
    ...
    public static class Material3VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material3.android</b> with value <b>1.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PlayServicesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>play.services.games</b> with value <b>23.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGames() { return getVersion("play.services.games"); }

    }

    public static class RoomVersionAccessors extends VersionFactory  {

        private final RoomExternalVersionAccessors vaccForRoomExternalVersionAccessors = new RoomExternalVersionAccessors(providers, config);
        public RoomVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.room.external</b>
         */
        public RoomExternalVersionAccessors getExternal() {
            return vaccForRoomExternalVersionAccessors;
        }

    }

    public static class RoomExternalVersionAccessors extends VersionFactory  {

        public RoomExternalVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>room.external.antlr</b> with value <b>2.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAntlr() { return getVersion("room.external.antlr"); }
